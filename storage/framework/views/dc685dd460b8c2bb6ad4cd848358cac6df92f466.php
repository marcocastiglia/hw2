<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(url('css/userpage.css')); ?>">
        ...
        <script src="<?php echo e(url('js/userpage.js')); ?>" defer></script>
            ...
            <main>
                ...
                <div class='profilo'>
                    <div class='nav_2'>
                        ...
                        <div class='links'>
                            <a href="<?php echo e(url('/homepage')); ?>" class="home">Home</a>
                            <a href="<?php echo e(url('/logout')); ?>" class='logout'>Logout</a>
                        </div>
                    </div>
                    <img src="<?php echo e(url('images/profile_default.jpg')); ?>">
                    <span>
                        <?php echo e($username); ?>
                ...
                <section id="options">
                    ...
                    <a href=" <?php echo e(url('homepage')); ?>" class="preferiti">
                        <img src="<?php echo e(url('images/not_favorite.png')); ?>">
                        <h4 class='hidden'>Preferiti</h4>
                    </a>
                    <a class="scrivi">
                        <img src="<?php echo e(url('images/writing.png')); ?>">
                        <h4 class='hidden'>Scrivi</h4>
                    </a>
                    <a class="modifica">
                        <img src="<?php echo e(url('images/pen_icon.png')); ?>">
                        <h4 class='hidden'>Modifica</h4>
                    </a>
                    <a class="pro_gif">
                        <img src="<?php echo e(url('images/giphy_logo.png')); ?>">
                ...
                <section id="mainspace">
                        ...
                        <form name='scrivi_form' method='post'>
                            ...
                            <div class='ingredients'>
                                ...
                                <div class='add_ingr'>
                                    ...
                                    <img src="<?php echo e(url('images/add_icon.png')); ?>">
                                </div> 
                    ...
                    <article class='modifica hidden'>
                        ...
                        <div class='confirm_pw'>
                            <span> 
                                <strong><em><?php echo e($username); ?></em></strong> conferma la password per procedere:
                            </span>
...
</html><?php /**PATH C:\Users\marcu\Desktop\HW1_Laravel\resources\views/userpage.blade.php ENDPATH**/ ?>